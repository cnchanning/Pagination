define("easy-pagination/1.0.0/pagination-debug", ["arale-widget/1.2.0/widget-debug", "arale-base/1.2.0/base-debug", "arale-class/1.2.0/class-debug", "arale-events/1.2.0/events-debug", "jquery/1.7.2/jquery-debug"], function(require, exports, module) {
  /**
   * Pagination 组件
   * @author channing
   * @version 1.0.0
